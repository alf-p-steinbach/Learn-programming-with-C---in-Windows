...
<img src="images/mandelbrot.jpg" width="25%" align="right">
...
<img src="images/coder.jpg" width="66%" align="left" margin="1em"/>
...
* **Interpretation**:  
  ...
  *Execution via interpretation:*  
  ...
  <img src="images/interpretation.50pct.svg" width="606.3" height="180.2">  
...
* **Compilation**:  
  ...
  *Creating the executable:*  
  ...
  <img src="images/compilation.50pct.svg">  
  
  <hr>
  
  *Executing the executable (any number of times):*
  
  <img src="images/running-an-executable.50pct.svg">
...
<img src="images/sshot-csh-gui-window.png" align="right" width="227">
...
The three last examples then illustrate the pure text environments known as *console windows*, which are much used, they’re almost indispensable!, in programming work. First there’s one example of using a general command interpreter in a console window. Most/all general command interpreters run in console windows, though you can run such a command interpreter in a console window like *view* in an editor that supports that. <img src="images/sshot-command-prompt.after-color-command.png" align="right" width="433">
Then come two minimal examples of programs to present a single line of text in a console, first one in C++ and then one in C#. And this &mdash; presenting text in a console &mdash; is the basis of the majority of beginner’s programs.
