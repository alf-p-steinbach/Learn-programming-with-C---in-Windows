...
* *Interpretation:*  
  ...
  In ordinary everyday language an interpreter translates from one spoken language to another, or perhaps is one who explains something. E.g. an interpreter of the symbolism in Munch’s paintings. In programming an interpreter “translates” from instructions to actions, effects.
