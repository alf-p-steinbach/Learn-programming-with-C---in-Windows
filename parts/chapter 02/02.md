...
But the next `=` assignment can change that, so it’s absolutely not equality forever, it’s a much more ephemeral effect!, and it’s absolutely not a standing order to maintain a correspondence or equality, just a value replacement that happens *here*.
