...
With a real programmer’s editor such as Notepad++ you would have available some menu item to open a File Explorer (a.k.a. Windows Explorer) view of the file’s folder. Alas, simple Notepad doesn’t provide that. However, chances are that you saved it in your **home folder**, which you can get to by opening a <img src="images/explorer icon.png" width="16"> **File Explorer** instance and typing, literally, `%userprofile%` (and pressing the enter/return key) in its address bar.
