...
<!-- **Table of Contents**  *generated with [DocToc](https://github.com/thlorenz/doctoc)* -->
  ...
  - [2.1 &nbsp;“Hello, world!”.](#21-nbsphello-world)
- [2.2 &nbsp;asd](#22-nbspasd)
...
With a real programmer’s editor such as Notepad++ you would have available some menu item to open a <img src="images/explorer icon.png" width="16"> **File Explorer** (a.k.a. Windows Explorer) view of the file’s folder. Alas, simple Notepad doesn’t provide that. However, chances are that you saved it in your **home folder**-, which you can get to by opening a File Explorer instance and typing, literally, `%userprofile%`, and pressing the enter/return key, in its address bar.

Otherwise you can just eliminate this mosquito with an intercontinental H-bomb missile, namely by using Windows’ general search &mdash; the same way we started Notepad. Only this time don’t type “n” for <u>N</u>otepad. Just  type enough of the filename that Windows finds it, e.g. “hello.j”:
...
Third detail: the address that the browser presents is a little different than the one in chapter 1 because *this* “hello.js.html” file was saved in a different place in the filesystem. We’ll explore the structure and geography of the filesystem, the space where files are stored, later. Suffice it to say for now that the browser tries to show that the file is stored at “C:\Users\Bjørn Håkon Sæther\hello.js.html” (drive “c:”, folder “\users\bjørn håkon sæther”, filename “hello.js.html”), but it replaces each backslash `\` with a forward slash `/`, and each space with `%20`.
